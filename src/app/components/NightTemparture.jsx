...
export const NightTemparture = () => {
  return (
    <div>
      <div className="w-103.5 h-207 rounded-[48px] bg-[rgba(17,24,39,0.75)] backdrop-blur-[12px] z-20 pt-2 relative">
        <div className="w-99.5 h-126 ml-1.5 mt-1.5 rounded-[42px] pt-14 pl-10 flex-col relative ">
          <p className="text-[18px] font-medium text-[#9CA3AF]">April 8,2025</p>
          <h1 className="text-5xl font-extrabold text-white">UlaanBaatar</h1>
          <img
            className="absolute top-49 left-[69.96px]"
            src="moon.png"
            alt=""
          />
          <img
